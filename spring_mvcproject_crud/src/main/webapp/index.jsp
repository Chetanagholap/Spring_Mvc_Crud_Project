...
<div class="container">
        <h1>Register</h1>
        <form action="saveManagerInfo" method="post">
            <div class="form-control">
                <input type="text" name="mname" placeholder="enter your name" required name="name">
                <label>Username</label>
            </div>
             <div class="form-control">
                <input type="email" name="memail" placeholder="enter your email" required name="email">
                <label>email</label>
            </div>
            <div class="form-control">
                <input type="password" name="mpass" placeholder="enter your password" required name="password">
                <label>Password</label>
            </div>
            <div class="form-control">
                <input type="password" name="mcpass" placeholder="enter your confirm password"  required name="password">
